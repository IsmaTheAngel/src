...
import com.ardium.pvp.blocks.BlockArdiumFurnace;
...
public class TileEntityArdiumFurnace    extends TileEntity
...
{
  return hasCustomInventoryName() ? this.furnaceName : "Ardium Furnace";
}
...
public void updateEntity()
{
  ...
  if (!this.worldObj.isRemote)
  {
    ...
    {
      flag1 = true;
      BlockArdiumFurnace.updateBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
    }
  }
  if (flag1) {
    markDirty();
