...
import com.ardium.pvp.recipies.ExtractorRecipies;
...
private boolean canSmelt()
{
  ...
  ItemStack itemstack = ExtractorRecipies.crafting().getSmeltingResult(new ItemStack[] { this.contents[0], this.contents[1], this.contents[2], this.contents[3], this.contents[4] });
  if (itemstack == null) {
    return false;
  }
