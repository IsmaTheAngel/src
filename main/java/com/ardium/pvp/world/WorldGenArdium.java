...
class WorldGenArdium implements IWorldGenerator {
    @Override
    ...
    private void addOreSpawn(Block block, int metadata, Block target, World world, Random random, int blockXPos, int
            blockZPos, int maxX, int maxZ, int maxVeinSize, int chancesToSpawn, int minY, int maxY) {
    ...
    private void generateSurface(World world, Random random, int x, int z) {
        addOreSpawn (RegistryBlocks.ardium_ore, 0, Blocks.stone, world, random, x, z, 16, 16, 10, 1, 3, 30);
