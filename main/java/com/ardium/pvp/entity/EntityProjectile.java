...
class EntityProjectile extends EntityArrow
    ...
    void applyEntityHitEffects(Entity entity) {
    ...
    void onGroundHit(MovingObjectPosition mop) {
    ...
    private void onItemPickup(EntityPlayer entityplayer) {
