...
public class EntityDynamite extends EntityProjectile
{
	  ...
	  public void onUpdate()
	  {
	    ...
	    else if (this.explodefuse > 0)
	    {
	      ...
	      this.worldObj.spawnParticle("smoke", this.posX - this.motionX * f6, this.posY - this.motionY * f6, this.posZ - this.motionZ * f6, this.motionX, this.motionY, this.motionZ);
	    }
	  }
	  ...
	  {
	    return new ItemStack(RegistryItems.ardium_ingot, 1);
	  }
