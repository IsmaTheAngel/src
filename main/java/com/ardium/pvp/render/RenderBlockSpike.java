  ...
  implements ISimpleBlockRenderingHandler
{
  public void renderInventoryBlock(Block block, int metadata, int modelID, RenderBlocks renderer)
  {
    ...
    renderSpikeBlock(Minecraft.getMinecraft().theWorld, 0, 0, 0, 1, 0, block, renderer, -1);
    GL11.glRotatef(-90.0F, 0.0F, 1.0F, 0.0F);
    GL11.glTranslatef(0.5F, 0.5F, 0.5F);
  }

    private boolean renderSpikeBlock(IBlockAccess world, int x, int y, int z, int side, int type, Block block, RenderBlocks renderer, int brightness)
  {
    float ax = 0.0F;
    float ay = 0.0F;
    float az = 0.0F;
    ...
    if (side != 0)
    {
      ...
      tessellator.addVertexWithUV(x + ax, y + ay, z + az, getU(0, texture, rotation, u, v), 
        getV(0, texture, rotation, u, v));
      tessellator.addVertexWithUV(x + bx, y + by, z + bz, getU(1, texture, rotation, u, v), 
        getV(1, texture, rotation, u, v));
      tessellator.addVertexWithUV(x + dx, y + dy, z + dz, getU(2, texture, rotation, u, v), 
        getV(2, texture, rotation, u, v));
      tessellator.addVertexWithUV(x + cx, y + cy, z + cz, getU(3, texture, rotation, u, v), 
    ...
    if (side != 1)
    {
      ...
      tessellator.addVertexWithUV(x + ex, y + ey, z + ez, getU(0, texture, rotation, u, v), 
        getV(0, texture, rotation, u, v));
      tessellator.addVertexWithUV(x + gx, y + gy, z + gz, getU(1, texture, rotation, u, v), 
        getV(1, texture, rotation, u, v));
      tessellator.addVertexWithUV(x + hx, y + hy, z + hz, getU(2, texture, rotation, u, v), 
        getV(2, texture, rotation, u, v));
      tessellator.addVertexWithUV(x + fx, y + fy, z + fz, getU(3, texture, rotation, u, v), 
        getV(3, texture, rotation, u, v));
    }
    if (inventory) {
      tessellator.draw();
    ...
    if (side != 2)
    {
      ...
      tessellator.addVertexWithUV(x + ax, y + ay, z + az, getU(0, texture, rotation, u, v), 
        getV(0, texture, rotation, u, v));
      tessellator.addVertexWithUV(x + ex, y + ey, z + ez, getU(1, texture, rotation, u, v), 
        getV(1, texture, rotation, u, v));
      tessellator.addVertexWithUV(x + fx, y + fy, z + fz, getU(2, texture, rotation, u, v), 
        getV(2, texture, rotation, u, v));
      tessellator.addVertexWithUV(x + bx, y + by, z + bz, getU(3, texture, rotation, u, v), 
        getV(3, texture, rotation, u, v));
    }
    if (inventory) {
      tessellator.draw();
    ...
    if (side != 3)
    {
      ...
      tessellator.addVertexWithUV(x + dx, y + dy, z + dz, getU(0, texture, rotation, u, v), 
        getV(0, texture, rotation, u, v));
      tessellator.addVertexWithUV(x + hx, y + hy, z + hz, getU(1, texture, rotation, u, v), 
        getV(1, texture, rotation, u, v));
      tessellator.addVertexWithUV(x + gx, y + gy, z + gz, getU(2, texture, rotation, u, v), 
        getV(2, texture, rotation, u, v));
      tessellator.addVertexWithUV(x + cx, y + cy, z + cz, getU(3, texture, rotation, u, v), 
        getV(3, texture, rotation, u, v));
    }
    ...
    if (side != 4)
    {
      ...
      tessellator.addVertexWithUV(x + cx, y + cy, z + cz, getU(0, texture, rotation, u, v), 
        getV(0, texture, rotation, u, v));
      tessellator.addVertexWithUV(x + gx, y + gy, z + gz, getU(1, texture, rotation, u, v), 
        getV(1, texture, rotation, u, v));
      tessellator.addVertexWithUV(x + ex, y + ey, z + ez, getU(2, texture, rotation, u, v), 
        getV(2, texture, rotation, u, v));
      tessellator.addVertexWithUV(x + ax, y + ay, z + az, getU(3, texture, rotation, u, v), 
        getV(3, texture, rotation, u, v));
    }
    if (inventory) {
      tessellator.draw();
    ...
    if (side != 5)
    {
      ...
      tessellator.addVertexWithUV(x + bx, y + by, z + bz, getU(0, texture, rotation, u, v), 
        getV(0, texture, rotation, u, v));
      tessellator.addVertexWithUV(x + fx, y + fy, z + fz, getU(1, texture, rotation, u, v), 
        getV(1, texture, rotation, u, v));
      tessellator.addVertexWithUV(x + hx, y + hy, z + hz, getU(2, texture, rotation, u, v), 
        getV(2, texture, rotation, u, v));
      tessellator.addVertexWithUV(x + dx, y + dy, z + dz, getU(3, texture, rotation, u, v), 
        getV(3, texture, rotation, u, v));
    }
    if (inventory) {
      tessellator.draw();
    ...
    private float getU(int i, IIcon texture, int rotation, float[] u, float[] v)
  {
    switch (rotation % 4)
    {
    case 0: 
    ...
    private float getV(int i, IIcon texture, int rotation, float[] u, float[] v)
  {
    switch (rotation % 4)
    {
    case 0: 
    ...
    private int calcRotation(int side, int direction)
  {
    if (side == direction) {
      return 0;
    }
    if (side == net.minecraft.util.Facing.oppositeSide[direction]) {
      return 0;
    }
    if (direction == 1) {
      return 0;
