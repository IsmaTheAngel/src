...
public class ModelArdium3DArmor extends ModelBiped {
	...
	public ModelArdium3DArmor(int slot) {
		this.slot = slot;

		textureWidth = 64;
		textureHeight = 128;
		float s = 0.2F;
        ModelRenderer fairy = new ModelRenderer (this, 34, 32);
        ...
        ModelRenderer helm3 = new ModelRenderer (this, 0, 32);
        ...
        ModelRenderer wing1_2 = new ModelRenderer (this, 56, 43);
		wing1_2.mirror = true;
        ...
        ModelRenderer helm1 = new ModelRenderer (this, 50, 32);
        ...
        ModelRenderer armRpauldron = new ModelRenderer (this, 0, 67);
        ...
        ModelRenderer helmWing2 = new ModelRenderer (this, 46, 45);
        ...
        ModelRenderer bootL1 = new ModelRenderer (this, 12, 79);
		bootL1.mirror = true;
        ...
        ModelRenderer bootR1 = new ModelRenderer (this, 12, 79);
        ...
        ModelRenderer wing2_1 = new ModelRenderer (this, 56, 42);
        ...
        ModelRenderer wing2_2 = new ModelRenderer (this, 56, 44);
		wing2_2.mirror = true;
        ...
        ModelRenderer belt = new ModelRenderer (this, 22, 56);
        ...
        ModelRenderer helmWing4 = new ModelRenderer (this, 46, 45);
        ...
        ModelRenderer helm2 = new ModelRenderer (this, 50, 32);
		helm2.mirror = true;
		helm2.setRotationPoint(0.0F, 0.0F, 0.0F);
		helm2.addBox(3.0F, -5.0F, -4.5F, 1, 5, 4, s);
        ModelRenderer wing2_3 = new ModelRenderer (this, 56, 44);
        ...
        ModelRenderer wing1 = new ModelRenderer (this, 56, 41);
		wing1.mirror = true;
        ...
        ModelRenderer body2 = new ModelRenderer (this, 0, 56);
		body2.setRotationPoint(0.0F, 0.0F, 0.0F);
		body2.addBox(-3.0F, 4.0F, -3.0F, 6, 6, 5, s);
		setRotateAngle(body2, -0.08726646259971647F, 0.0F, 0.0F);
        ModelRenderer helmWing3 = new ModelRenderer (this, 32, 45);
        ...
        ModelRenderer helmWing1 = new ModelRenderer (this, 32, 45);
        ...
        ModelRenderer wing2 = new ModelRenderer (this, 56, 42);
		wing2.mirror = true;
        ...
        ModelRenderer wing1_3 = new ModelRenderer (this, 56, 43);
    ...
    private void prepareForRender(Entity entity) {
