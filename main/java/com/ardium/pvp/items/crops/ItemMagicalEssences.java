...
public class ItemMagicalEssences extends Item
{
    private static final String[] field_150923_a = {"inferium", "intermedium", "superium", "supremium", "fertilized"};
    private static final String[] field_150921_b = {"inferium_essence", "intermedium_essence", "superium_essence", "supremium_essence", "fertilized_essence"};
	  @SideOnly(Side.CLIENT)
	  private IIcon[] field_150920_d;
	  private static final String __OBFID = "CL_00000022";
	  
	  public ItemMagicalEssences()
	  {
	    setHasSubtypes(true);
	    setMaxDamage(0);
