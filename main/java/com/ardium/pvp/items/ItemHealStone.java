...
class ItemHealStone extends Item {
    public ItemHealStone() {
        setMaxDamage (32);
        setMaxStackSize (1);
    }
    ...
    public ItemStack onItemRightClick(ItemStack item, World world, EntityPlayer player) {
        ...
        if ( item.stackTagCompound.getInteger ("timer") == 0 ) {
            ...
            player.addChatComponentMessage (new ChatComponentTranslation (EnumChatFormatting.RED + "Tu dois attendre que la pierre se recharge !"));
        }
        return item;
    }
