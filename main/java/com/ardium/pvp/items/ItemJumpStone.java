...
class ItemJumpStone extends Item {
    ...
    public ItemStack onItemRightClick(ItemStack item, World world, EntityPlayer player) {
        ...
        if ( item.stackTagCompound.getInteger ("timer") == 0 ) {
            ...
            player.addChatComponentMessage (new ChatComponentTranslation (EnumChatFormatting.DARK_GREEN + "Tu dois attendre que la pierre se recharge !"));
        }
        return item;
    }
