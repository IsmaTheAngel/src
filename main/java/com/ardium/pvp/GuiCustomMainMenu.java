...
class GuiCustomMainMenu extends GuiScreen implements GuiYesNoCallback {
    private static final String field_96138_a = "Please click " + EnumChatFormatting.UNDERLINE + "here" + EnumChatFormatting
     ...
     */
        ...
        this.field_110351_G = this.mc.getTextureManager ().getDynamicTextureLocation ("background", viewportTexture);
        ...
        synchronized (this.field_104025_t) {
            ...
            int field_92022_t = (this.width - j) / 2;
            int field_92021_u = ((GuiButton) this.buttonList.get (0)).yPosition - 24;
            int field_92020_v = field_92022_t + j;
            int field_92019_w = field_92021_u + 24;
        }
    }
    ...
    private void addSingleplayerMultiplayerButtons() {
        ...
        int par2 = 24;
        this.buttonList.add (new GuiButton (3310, this.width / 2 + 2, par1 + 42, 98, 20, EnumChatFormatting.GOLD + "" + "Boutique"));
        this.buttonList.add (new GuiButton (3311, this.width / 2 - 100, par1 + 42, 98, 20, EnumChatFormatting.RESET + "" + "You" + EnumChatFormatting.DARK_RED + "" + "Tube"));
    ...
    protected void actionPerformed(GuiButton p_146284_1_) {
        if ( p_146284_1_.id == 3310 ) {
            try {
                ...
                oclass.getMethod ("browse", new Class[]{URI.class}).invoke (object, new URI ("http://shop.ardium-pvp.com"));
        ...
        if ( p_146284_1_.id == 3311 ) {
            try {
                Class oclass = Class.forName ("java.awt.Desktop");
                Object object = oclass.getMethod ("getDesktop", new Class[0]).invoke (null);
                oclass.getMethod ("browse", new Class[]{URI.class}).invoke (object, new URI ("https://youtube.fr/chetom21"));
            } catch (Throwable throwable) {
                logger.error ("Couldn't open link", throwable);
            }
        }
        ...
        if ( p_146284_1_.id == 3312 ) {
            try {
                Class oclass = Class.forName ("java.awt.Desktop");
                Object object = oclass.getMethod ("getDesktop", new Class[0]).invoke (null);
                oclass.getMethod ("browse", new Class[]{URI.class}).invoke (object, new URI ("https://discord.gg/vXgEuE4"));
            } catch (Throwable throwable) {
