...
class BlockInstable extends Block {
	private IIcon[] icons = new IIcon[16];
	private String folder;
	  private int renderPass;
	  
	  public BlockInstable(String location, boolean hasAlpha)
	  {
	    super(Material.rock);
	...
	private IIcon getConnectedBlockTexture(IBlockAccess par1IBlockAccess, int par2, int par3, int par4, int par5, IIcon[] icons)
	  {
