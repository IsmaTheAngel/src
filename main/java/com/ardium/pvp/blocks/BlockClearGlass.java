...
class BlockClearGlass extends Block {
	String folder;
	private IIcon[] icons = new IIcon[16];
	  private int renderPass;

	BlockClearGlass(String location, boolean hasAlpha)
	  {
	    super(Material.rock);
	...
	boolean shouldConnectToBlock(IBlockAccess par1IBlockAccess, int par2, int par3, int par4, Block par5, int par6)
	  {
	    return par5 == this;
	  }
	...
	IIcon getConnectedBlockTexture(IBlockAccess par1IBlockAccess, int par2, int par3, int par4, int par5, IIcon[] icons)
	  {
	  ...
	  {
		  boolean shouldRenderSelectionBox = true;
