...
import com.ardium.pvp.blocks.crops.*;
import com.ardium.pvp.newcrops.AmorphaCrop;
import com.ardium.pvp.newcrops.CleomeCrop;
...
public class RegistryBlocks 
{
    ...
    public static Block big_ardium_block;
	...
	public static void init() {
        ardium_ore = new BlockBasic (Material.rock, 2).setBlockName ("ardium_ore").setCreativeTab (Ardium.ARDIUM_CREATIVE_TAB).setBlockTextureName (Ardium.MOD_ID + ":ardium_ore").setHardness (5.0F);
	GameRegistry.registerBlock(ardium_ore, ardium_ore.getUnlocalizedName().substring(5));


        ardium_block = new BlockBasic (Material.rock, 2).setBlockName ("ardium_block").setCreativeTab (Ardium.ARDIUM_CREATIVE_TAB).setBlockTextureName (Ardium.MOD_ID + ":ardium_block").setHardness (5.0F);
	GameRegistry.registerBlock(ardium_block, ardium_block.getUnlocalizedName().substring(5));

        big_ardium_block = new BlockBasic (Material.rock, 2).setBlockName ("big_ardium_block").setCreativeTab (Ardium.ARDIUM_CREATIVE_TAB).setBlockTextureName (Ardium.MOD_ID + ":big_ardium_block").setHardness (5.0F);
	GameRegistry.registerBlock(big_ardium_block, big_ardium_block.getUnlocalizedName().substring(5));

        ardium_furnace = new BlockArdiumFurnace (true, "ardium_furnace_off").setBlockName ("ardium_furnace").setCreativeTab (Ardium.ARDIUM_CREATIVE_TAB);
	GameRegistry.registerBlock(ardium_furnace, ardium_furnace.getUnlocalizedName().substring(5));

        Block rainbowLamp = new BlockBasic (Material.rock, 2).setBlockName ("RainbowLamp").setCreativeTab (Ardium.ARDIUM_CREATIVE_TAB).setBlockTextureName (Ardium.MOD_ID + ":rainbow_lamp").setHardness (5.0F).setLightLevel (2.0F);
	...
	GameRegistry.registerBlock(lanternPhys, lanternPhys.getUnlocalizedName().substring(5));
        ...
        Block iron_box = new IronBox (Material.cactus).setBlockName ("iron_box").setBlockTextureName (Ardium.MOD_ID + ":iron_box").setCreativeTab (Ardium.ARDIUM_CREATIVE_TAB).setHardness (2.0F);
    ...
    GameRegistry.registerBlock(air_crop, air_crop.getUnlocalizedName().substring(5));
        ...
        Block ardium_stairs = new BlockStairsMod (ardium_block, 0).setBlockName ("ardium_stairs").setCreativeTab (Ardium.ARDIUM_CREATIVE_TAB);
        Block ardium_fences = new BlockFenceMod ("ardium:ardium_block", Material.rock).setBlockName ("ardium_fences").setCreativeTab (Ardium.ARDIUM_CREATIVE_TAB).setHardness (5.0F);
