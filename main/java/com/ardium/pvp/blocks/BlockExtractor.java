...
class BlockExtractor extends BlockContainer
{
    ...
    public boolean hasTileEntity(int metadata)
	  ...
	  {
	    this.blockIcon = iiconRegister.registerIcon("ardium:ardiumextractor");
	    this.autreface = iiconRegister.registerIcon("ardium:ardiumextractor_front");
	  }
