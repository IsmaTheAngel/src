...
public abstract class HarvestTools extends ToolCore
{
	...
	public boolean func_150897_b(Block block) {
		return block.getMaterial ().isToolNotRequired () || isEffective (block.getMaterial ());
	}
	...
	boolean isEffective(Block block, int meta) {
		return getHarvestType ().equals (block.getHarvestTool (meta)) || isEffective (block.getMaterial ());
	  }
	...
	void breakExtraBlock(World world, int x, int y, int z, int sidehit, EntityPlayer player, int refX, int refY, int refZ)
	  {
