...
class AbilityHelper {
    ...
    private static void damageTool(ItemStack stack, int dam, NBTTagCompound tags, EntityLivingBase entity, boolean ignoreCharge)
	  {
    ...
    private static void breakTool(ItemStack stack, NBTTagCompound tags, Entity entity)
	  {
