...
public class BlockOxiumFurnace extends BlockContainer
{
	 public BlockOxiumFurnace(boolean p_i45407_1_,String texture)
	    {
	        super(Material.rock);
   ...
   {
       return Item.getItemFromBlock(RegistryBlocks.oxium_furnace);
   }
   ...
   {
       this.blockIcon = p_149651_1_.registerIcon("ardium:oxium_block");
       this.field_149936_O = p_149651_1_.registerIcon(this.field_149932_b ? "ardium:furnace_oxium_front_off" : "ardium:furnace_oxium_front_on");
       this.field_149935_N = p_149651_1_.registerIcon("ardium:oxium_block");
   }
   ...
   {
       return new TileEntityOxiumFurnace();
   }
   public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ)
	  {

       player.openGui(Ardium.instance, 6, world, x, y, z);
       return true;
     }
   ...
   public void breakBlock(World p_149749_1_, int p_149749_2_, int p_149749_3_, int p_149749_4_, Block p_149749_5_, int p_149749_6_)
   {
       if (!field_149934_M)
       {
       	TileEntityOxiumFurnace TileEntityOxiumFurnace = (TileEntityOxiumFurnace)p_149749_1_.getTileEntity(p_149749_2_, p_149749_3_, p_149749_4_);

           if (TileEntityOxiumFurnace != null)
           {
               for (int i1 = 0; i1 < TileEntityOxiumFurnace.getSizeInventory(); ++i1)
               {
                   ItemStack itemstack = TileEntityOxiumFurnace.getStackInSlot(i1);
   ...
   public static void updateBlockState(boolean p_149931_0_, World p_149931_1_, int p_149931_2_, int p_149931_3_, int p_149931_4_)
   {
     ...
     field_149934_M = true;
     if (p_149931_0_) {
       p_149931_1_.setBlock(p_149931_2_, p_149931_3_, p_149931_4_, RegistryBlocks.oxium_furnace);
     } else {
       p_149931_1_.setBlock(p_149931_2_, p_149931_3_, p_149931_4_, RegistryBlocks.oxium_furnace);
     }
