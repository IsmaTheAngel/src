...
{
	 public BlockArdiumFurnace(boolean p_i45407_1_,String texture)
	    {
	        super(Material.rock);
   ...
   {
       this.blockIcon = p_149651_1_.registerIcon("ardium:ardium_block");
       this.field_149936_O = p_149651_1_.registerIcon(this.field_149932_b ? "ardium:furnace_front_off" : "ardium:furnace_front_on");
       this.field_149935_N = p_149651_1_.registerIcon("ardium:ardium_block");
   }
   ...
   public static void updateBlockState(boolean p_149931_0_, World p_149931_1_, int p_149931_2_, int p_149931_3_, int p_149931_4_)
   {
     ...
     field_149934_M = true;
     if (p_149931_0_) {
       p_149931_1_.setBlock(p_149931_2_, p_149931_3_, p_149931_4_, RegistryBlocks.ardium_furnace);
     } else {
       p_149931_1_.setBlock(p_149931_2_, p_149931_3_, p_149931_4_, RegistryBlocks.ardium_furnace);
     }
