...
import fr.ardium.mod.items.crops.*;
...
public class RegistryItems {
    ...
    public static void init() {
        ardium_ingot = new Item ().setUnlocalizedName ("ardium_ingot").setCreativeTab (Ardium.ArdiumCreativeTab).setTextureName (Ardium.MOD_ID + ":ardium_ingot");
        GameRegistry.registerItem (ardium_ingot, "ardium_ingot");

        dynamite = new ItemDynamite ("Dynamite").setUnlocalizedName ("dynamite").setCreativeTab (Ardium.ArdiumCreativeTab).setTextureName (Ardium.MOD_ID + ":dynamite");
        GameRegistry.registerItem (dynamite, "dynamite");

        ardium_apple = new ItemArdiumApple (10, 10F, false).setAlwaysEdible ().setUnlocalizedName ("ardium_apple").setCreativeTab (Ardium.ArdiumCreativeTab).setTextureName (Ardium.MOD_ID + ":ardium_apple");
        GameRegistry.registerItem (ardium_apple, "ardium_apple");

        backpack = new ItemBackpack ();
        GameRegistry.registerItem (backpack, "backpack");

        wand_explorer = new ItemWandExplorer ().setUnlocalizedName ("wand_explorer").setCreativeTab (Ardium.ArdiumCreativeTab).setTextureName (Ardium.MOD_ID + ":wand_explorer");
        ;
        ...
        spruce_door = new ItemSpruceDoor (Material.wood).setUnlocalizedName ("spruce_door").setCreativeTab (CreativeTabs.tabRedstone).setTextureName (Ardium.MOD_ID + ":spruce_door");
        GameRegistry.registerItem (spruce_door, "spruce_door");

        acacia_door = new ItemAcaciaDoor (Material.wood).setUnlocalizedName ("acacia_door").setCreativeTab (CreativeTabs.tabRedstone).setTextureName (Ardium.MOD_ID + ":acacia_door");
        GameRegistry.registerItem (acacia_door, "acacia_door");

        birch_door = new ItemBirchDoor (Material.wood).setUnlocalizedName ("birch_door").setCreativeTab (CreativeTabs.tabRedstone).setTextureName (Ardium.MOD_ID + ":birch_door");
        GameRegistry.registerItem (birch_door, "birch_door");

        jungle_door = new ItemJungleDoor (Material.wood).setUnlocalizedName ("jungle_door").setCreativeTab (CreativeTabs.tabRedstone).setTextureName (Ardium.MOD_ID + ":jungle_door");
        GameRegistry.registerItem (jungle_door, "jungle_door");

        dark_oak_door = new ItemDarkOakDoor (Material.wood).setUnlocalizedName ("dark_oak_door").setCreativeTab (CreativeTabs.tabRedstone).setTextureName (Ardium.MOD_ID + ":dark_oak_door");
        ...
        amorpha_seeds = new amorpha_seeds (RegistryBlocks.amorpha_crop, Blocks.farmland).setUnlocalizedName ("amorpha_seeds").setTextureName (Ardium.MOD_ID + ":amorpha_seeds").setCreativeTab (Ardium.ArdiumCreativeTab);
        GameRegistry.registerItem (amorpha_seeds, "amorpha_seeds");

        amorpha_petal = new Item ().setUnlocalizedName ("amorpha_petal").setTextureName (Ardium.MOD_ID + ":amorpha_petal").setCreativeTab (Ardium.ArdiumCreativeTab);
        GameRegistry.registerItem (amorpha_petal, "amorpha_petal");

        leave = new Item ().setUnlocalizedName ("leave").setTextureName (Ardium.MOD_ID + ":leave").setCreativeTab (Ardium.ArdiumCreativeTab);
        GameRegistry.registerItem (leave, "leave");

        cleome_seeds = new CleomeSeeds (RegistryBlocks.cleome_crop, Blocks.farmland).setUnlocalizedName ("cleome_seeds").setTextureName (Ardium.MOD_ID + ":cleome_seeds").setCreativeTab (Ardium.ArdiumCreativeTab);
