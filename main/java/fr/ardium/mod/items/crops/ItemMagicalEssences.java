...
{
	  public static final String[] field_150923_a = { "inferium", "intermedium", "superium", "supremium", "fertilized" };
	  public static final String[] field_150921_b = { "inferium_essence", "intermedium_essence", "superium_essence", "supremium_essence", "fertilized_essence" };
