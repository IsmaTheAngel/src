...
{
	  public static final String[] field_150923_a = { "gold", "redstone", "emerald" };
	  public static final String[] field_150921_b = { "essence_gold", "essence_redstone", "essence_emerald"};
