...
import fr.ardium.mod.blocks.BlockOxiumFurnace;
...
public class TileEntityOxiumFurnace    extends TileEntity
...
{
  return hasCustomInventoryName() ? this.furnaceName : "Oxium Furnace";
}
...
{
  return this.furnaceCookTime * par1 / 1;
}
...
public void updateEntity()
{
  ...
  if (!this.worldObj.isRemote)
  {
    ...
    {
      flag1 = true;
      BlockOxiumFurnace.updateBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
    }
  }
  if (flag1) {
    markDirty();
