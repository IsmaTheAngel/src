...
public class ContainerOxiumFurnace  extends Container
{
    private TileEntityOxiumFurnace tileFurnace;
    private int lastCookTime;
    private int lastBurnTime;
    private int lastItemBurnTime;
    private static final String __OBFID = "CL_00001748";

    public ContainerOxiumFurnace(InventoryPlayer p_i1812_1_, TileEntityOxiumFurnace p_i1812_2_)
    {
    ...
    public ItemStack transferStackInSlot(EntityPlayer p_82846_1_, int p_82846_2_)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            else if (p_82846_2_ != 1 && p_82846_2_ != 0)
            {
                ...
                else if (TileEntityOxiumFurnace.isItemFuel(itemstack1))
                {
