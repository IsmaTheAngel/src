...
public class GuiArdiumFurnace extends GuiContainer
{
    private static final ResourceLocation furnaceGuiTextures = new ResourceLocation("textures/gui/container/furnace.png");
    private TileEntityArdiumFurnace tileFurnace;
    private static final String __OBFID = "CL_00000758";

    public GuiArdiumFurnace(InventoryPlayer p_i1091_1_, TileEntityArdiumFurnace p_i1091_2_)
    {
        super(new ContainerArdiumFurnace(p_i1091_1_, p_i1091_2_));
