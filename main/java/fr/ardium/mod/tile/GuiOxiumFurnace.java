...
public class GuiOxiumFurnace extends GuiContainer
{
    private static final ResourceLocation furnaceGuiTextures = new ResourceLocation("textures/gui/container/furnace.png");
    private TileEntityOxiumFurnace tileFurnace;
    private static final String __OBFID = "CL_00000758";

    public GuiOxiumFurnace(InventoryPlayer p_i1091_1_, TileEntityOxiumFurnace p_i1091_2_)
    {
        super(new ContainerOxiumFurnace(p_i1091_1_, p_i1091_2_));
