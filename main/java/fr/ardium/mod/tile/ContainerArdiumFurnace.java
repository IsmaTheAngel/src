...
public class ContainerArdiumFurnace  extends Container
{
    private TileEntityArdiumFurnace tileFurnace;
    private int lastCookTime;
    private int lastBurnTime;
    private int lastItemBurnTime;
    private static final String __OBFID = "CL_00001748";

    public ContainerArdiumFurnace(InventoryPlayer p_i1812_1_, TileEntityArdiumFurnace p_i1812_2_)
    {
    ...
    public void updateProgressBar(int p_75137_1_, int p_75137_2_)
    {
        ...
        if (p_75137_1_ == 2)
        {
            this.tileFurnace.currentBurnTime = p_75137_2_;
        }
    }
    ...
    public ItemStack transferStackInSlot(EntityPlayer p_82846_1_, int p_82846_2_)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            else if (p_82846_2_ != 1 && p_82846_2_ != 0)
            {
                ...
                else if (TileEntityArdiumFurnace.isItemFuel(itemstack1))
                {
