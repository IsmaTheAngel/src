...
import fr.ardium.mod.tools.ToolAtomicDissasembler;
  ...
  implements IItemRenderer
{
  ...
  public void renderItem(IItemRenderer.ItemRenderType type, ItemStack item, Object... data)
  {
    ...
    if ((item.getItem() instanceof ToolAtomicDissasembler))
    {
      GL11.glPushMatrix();
      ...
      this.mc.renderEngine.bindTexture(new ResourceLocation("ardium", "textures/render/AtomicDissasembler.png"));
